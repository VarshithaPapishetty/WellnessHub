...
<body>
    ...
    <script>
        ...
        const todoList = [
            '1. Frequent Small Meals: Eat smaller, more frequent meals to maintain metabolism and avoid hunger spikes.',
            '2. Flexibility and Balance: Incorporate flexibility and balance exercises like yoga or Pilates to improve overall fitness.',
            '3. Avoid Smoking and Alcohol: Reduce or eliminate smoking and limit alcohol consumption to improve overall health.',
