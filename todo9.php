...
<body>
    ...
    <script>
        ...
        const todoList = [
            '1.Frequent Meals: Eat 5-6 smaller meals throughout the day instead of 3 large ones.',
            '2. Avoid Empty Calories*: Limit junk food and sugary drinks; focus on nutrient-rich foods.',
            '3. Compound Exercises*: Focus on exercises like squats, deadlifts, bench presses, and rows that work multiple muscle groups.',
