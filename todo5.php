...
<body>
    ...
    <script>
        ...
        const todoList = [
            '1. Choose lean protein sources like poultry, fish, and legumes.',
            '2.Aim for 150 minutes of moderate-intensity exercise (brisk walking, cycling, swimming) per week.',
            '3. Manage stress levels (meditation, yoga, deep breathing).',
            '4. Increase physical activity throughout the day (take the stairs, walk to work).',
