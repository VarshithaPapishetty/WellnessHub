...
<body>
    ...
    <script>
        ...
        const todoList = [
            '1.Choose whole grains, lean proteins, and healthy fats.',
            '2. Limit added sugars, saturated fats, and refined carbs.',
            '3. Consider a meal replacement shake or bar to help with portion control.',
            '4. Aim for 150 minutes of moderate-intensity exercise per week.',
            '5. Incorporate strength training 2-3 times a week to build muscle.',
            '6. Consider seeking support from a healthcare professional, registered dietitian, or weight loss support group.'
        ];
