...
<body>
    ...
    <div class="doctor-list">
        <div class="doctor-item" onclick="showAppointmentForm('Dr. Prerna Reddy')">
            <div class="photo">
                <img src="doc1.jpg" alt="Doctor 1 Photo"> <!-- Replace with actual photo path -->
            </div>
            <div class="doctor-details">
                <h2>Dr. Prerna Reddy</h2>
                <p>Specialist: Cardiology</p>
                <p>Phone: +1234567890</p>
            </div>
        </div>
        <div class="doctor-item" onclick="showAppointmentForm('Dr. Gopal Chowdhary')">
            <div class="photo">
                <img src="mdoc1.avif" alt="Doctor 2 Photo"> <!-- Replace with actual photo path -->
            </div>
            <div class="doctor-details">
                <h2>Dr. Gopal Chowdhary</h2>
                <p>Specialist: Neurology</p>
                <p>Phone: +0987654321</p>
            </div>
        </div>
        <div class="doctor-item" onclick="showAppointmentForm('Dr. Shirish Gupta')">
            <div class="photo">
                <img src="mdoc2.webp" alt="Doctor 3 Photo"> <!-- Replace with actual photo path -->
            </div>
            <div class="doctor-details">
                <h2>Dr. Shirish Gupta</h2>
    ...
    <div class="appointment-details" id="appointmentFormPrerna">
        <h2>Appointment Details with Dr. Prerna Reddy</h2>
        <label for="appointmentDatePrerna">Date:</label>
        <input type="date" id="appointmentDatePrerna" name="appointmentDatePrerna" required>
        <label for="appointmentTimePrerna">Time Slot:</label>
        <select id="appointmentTimePrerna" name="appointmentTimePrerna" required>
        ...
        <button onclick="submitAppointment(1, 10)">Submit</button>
    </div>

    <!-- Appointment Details Form for Dr. Gopal Chowdhary -->
    <div class="appointment-details" id="appointmentFormGopal">
        <h2>Appointment Details with Dr. Gopal Chowdhary</h2>
        <label for="appointmentDateGopal">Date:</label>
        <input type="date" id="appointmentDateGopal" name="appointmentDateGopal" required>
        <label for="appointmentTimeGopal">Time Slot:</label>
        <select id="appointmentTimeGopal" name="appointmentTimeGopal" required>
            <option value="09:00">9:00 AM</option>
            <option value="11:00">11:00 AM</option>
            <option value="14:00">2:00 PM</option>
            <option value="16:00">4:00 PM</option>
        ...
        <button onclick="submitAppointment(3,10)">Submit</button>
    </div>

    <!-- Appointment Details Form for Dr. Shirish Gupta -->
    <div class="appointment-details" id="appointmentFormShirish">
        <h2>Appointment Details with Dr. Shirish Gupta</h2>
        <label for="appointmentDateShirish">Date:</label>
        <input type="date" id="appointmentDateShirish" name="appointmentDateShirish" required>
        <label for="appointmentTimeShirish">Time Slot:</label>
        <select id="appointmentTimeShirish" name="appointmentTimeShirish" required>
            <option value="09:00">9:00 AM</option>
            <option value="11:00">11:00 AM</option>
            <option value="14:00">2:00 PM</option>
            <option value="16:00">4:00 PM</option>
        ...
        <button onclick="submitAppointment(4,10)">Submit</button>
    </div>
	...
	window.onload = function() {
        ...
        function setMinDate() {
            ...
            document.getElementById('appointmentDatePrerna').setAttribute('min', today);
            document.getElementById('appointmentDateGopal').setAttribute('min', today);
            document.getElementById('appointmentDateShirish').setAttribute('min', today);
        }
	$(document).ready(function() {
        ...
        function showAppointmentForm(doctorName) {
            ...
            if (doctorName === 'Dr. Prerna Reddy') {
                document.getElementById('appointmentFormPrerna').classList.add('active');
            } else if (doctorName === 'Dr. Gopal Chowdhary') {
                document.getElementById('appointmentFormGopal').classList.add('active');
            } else if (doctorName === 'Dr. Shirish Gupta') {
                document.getElementById('appointmentFormShirish').classList.add('active');
            }
        }
    ...
    if (doctorId === 1) {
        appointmentDate = document.getElementById('appointmentDatePrerna').value;
        appointmentTime = document.getElementById('appointmentTimePrerna').value;
    } else if (doctorId === 3) {
        appointmentDate = document.getElementById('appointmentDateGopal').value;
        appointmentTime = document.getElementById('appointmentTimeGopal').value;
    } else if (doctorId === 4) {
        appointmentDate = document.getElementById('appointmentDateShirish').value;
        appointmentTime = document.getElementById('appointmentTimeShirish').value;
    }
